        ...
        <div class="content-wrap">
            <div class="py-70 text-center">
                <div class="container shape-parent">
                    ...
                    <p class="mb-10 pb-2 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="200">Make payment using the <em style="text-decoration: underline">designers code</em> below.</p>
                            ...
                            <div class="table-responsive-md">
                                <table class="table table-hover table-projects table-underline table-light table-border-dark text-white mb-0">
                                    <tbody>
                                        ...
                                        <tr class="show-on-scroll" data-show-delay="50" data-show-duration="400" data-show-distance="10">
                                            <td class="table-projects-brand text-dark"><b>Brand Name:</b></td>
                                            <td class="table-projects-title text-dark"><?php echo $_SESSION['brandName']; ?></td>
                                        </tr>

                                        <tr class="show-on-scroll" data-show-delay="50" data-show-duration="400" data-show-distance="10">
                                            <td class="table-projects-brand text-dark"><b>Category:</b></td>
                                            <td class="table-projects-title text-dark"><?php echo $_SESSION['designerCategory']; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php
                                    if ($_SESSION['designerCategory'] == 'Don'){
                                        $designerCat = '₦150,000';
                                    }
                                    if ($_SESSION['designerCategory'] == 'Woko'){
                                        $designerCat = '₦100,000';
                                    }
                                    if ($_SESSION['designerCategory'] == 'Etibo'){
                                        $designerCat = '₦50,000';
                                    }
                                ?>
                                <p class="text-center pt-20 mb-20">Pay the sum of <b><?php echo $designerCat; ?></b> using the details below.<br>
