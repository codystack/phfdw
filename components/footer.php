        <footer class="footer bg-dark text-white shape-parent overflow-hidden text-center pt-60 pb-60">
            ...
            <div class="container pt-4">
                ...
                <ul class="nav nav-social nav-gap-sm align-items-center justify-content-center mb-30 text-white">
                    ...
                    <li class="nav-item">
                        <a href="https://www.instagram.com/phfdweek/" target="_blank" class="nav-link">
            ...
            if (isset($_SESSION['model_success_message']))
            {
                ...
                <script>
                    swal({
                        ...
                        window.location = "topModel_regSuccess";
                    });
                </script>
                <?php
