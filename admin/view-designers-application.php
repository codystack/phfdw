                                    ...
                                    <div class="card bg-opaque-white">
                                        <div class="card-header">
                                            <div class="row g-2 g-xl-5 align-items-center">
                                                <div class="col-md-6">
                                                    <a href="exhibitors-application" class="btn btn-with-icon btn-dark">
                                        ...
                                        <?php
                                            $id = $_GET['id'];
                                                $select_query = "SELECT * FROM designers WHERE id ='$id'";
                                        ...
                                        <div class="card-body bg-white">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label for="company" class="form-label">Instagram</label>
                                                    <input type="text" class="form-control" required name="company" disabled value="<?php echo $instagram; ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label for="company" class="form-label">participated in any </label>
                                                    <textarea type="text" name="items" required class="form-control form-control-lg form-control-white" disabled rows="2" placeholder="Items to be exhibited *"><?php echo $participated; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <?php 
