                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-8 show-on-scroll" data-show-duration="700">
                            <h1 class="text-white mb-0">About PHFDW</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12 col-lg-10">
                            <div class="row gh-5 gv-5">
                                ...
                                <div class="col-12 col-md-6 show-on-scroll" data-show-duration="700">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide overflow-hidden">
                                                    <div class="swiper-image" data-swiper-parallax-x="20%">
                                                        <img class="w-100" src="assets/images/about/about-us1.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="swiper-slide overflow-hidden">
                                                    <div class="swiper-image" data-swiper-parallax-x="20%">
                                                        <img class="w-100" src="assets/images/about/about-us2.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="swiper-slide overflow-hidden">
                                                    <div class="swiper-image" data-swiper-parallax-x="20%">
                                                        <img class="w-100" src="assets/images/about/about-us3.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <p class="pt-0 mt-100 mb-0" style="text-align: justify">In 2019 when we first launched the Port Harcourt Fashion and Design week brand, the theme of the event was “Fashion…the new Oil and Gas” The essence was to draw attention to the creative industry, celebrate Sme’s who are already making impact in that sector and encourage youths who had interest in the industry to genuinely pursue their interest. Port Harcourt Hitherto have been known as the Oil rich city and youths who could not find themselves in the oil and gas sector felt out of place. That narrative needed to change and we were able to achieve it through the Master classes facilitated by veterans of the Fashion Industry, Lexy Mojo Eyes, Frank Osodi, celebrity makeup artist, Marco Louis who came all the way from South Africa to teach and inspire our youths, entrepreneurship coach and formal president of the Port Harcourt Chamber of Commerce Engr. Emeka Unachukwu and Mrs Gift Nwankwo.</p>
                                </div>
                                <div class="col-12 col-md-6 show-on-scroll" data-show-duration="700">
                                    <p class="pt-0 mt-10 mb-0" style="text-align: justify">This year, thanks to the Vlisco Creative Promise in Fashion Contest of 2019, many of the youths are ready and so eager to see what the fashion week holds for them, as they cannot wait to unveil their creative skills while we intend to bring to the attention of the government and policy makers, how much this industry can help in Revitalizing the economy of the state while establishing port Harcourt as a tourist destination.</p>
                                    <img src="assets/images/bout.jpg" width="430px">
                                </div>
                                <div class="col-12 col-md-6 show-on-scroll" data-show-duration="700">
                                    <p class="pt-0 mt-10 mb-0" style="text-align: justify">Historically the fashion industry has been used to uplift urban-based development objectives and the sector continues to be viewed as an important tool for economic and tourism development at a local and international level. Cities like Paris, Milan, London and New York have long been applauded for their thriving fashion industries they have achieved a strong position as international fashion capitals of the world. In Africa, South Africa have also used Fashion Tourism as a vehicle to project its cities while Lagos Nigeria is not left out.</p>
                                    <p class="pt-0 mt-10 mb-0" style="text-align: justify">It is on this premise that that this year’s theme, <b>“Revitalizing the Economy through Fashion Tourism"</b> was borne. </p>
                                    <p class="pt-0 mt-10 mb-0" style="text-align: justify">During the Fashion Week, the idea is for the world to beam its light on the city of Port Harcourt, enjoying the culture and sophistication that abound with the people.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="pb-130 text-center text-md-left">
                    ...
                    <div class="row gv-1 pb-7 mb-n30 align-items-center justify-content-center justify-content-md-between">
                        ...
                        <div class="col-auto">
                            <a href="contact" class="btn btn-clean mt-17 mt-md-0 mr-xl-100">
